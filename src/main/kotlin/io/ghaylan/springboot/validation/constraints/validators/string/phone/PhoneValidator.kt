...
object PhoneValidator : ConstraintValidator<CharSequence, PhoneConstraint>()
{
    ...
    ) : ApiError?
    {
        ...
        {
            return ApiError(code = ApiErrorCode.PHONE_FORMAT_VIOLATION, message = "Must be a valid international phone number (Only digits)")
        }
    ...
    override fun applicableErrorCodes(): Array<ApiErrorCode> = arrayOf(
        ApiErrorCode.PHONE_FORMAT_VIOLATION,
        ApiErrorCode.PHONE_TYPE_VIOLATION,
        ApiErrorCode.PHONE_COUNTRY_VIOLATION)
}