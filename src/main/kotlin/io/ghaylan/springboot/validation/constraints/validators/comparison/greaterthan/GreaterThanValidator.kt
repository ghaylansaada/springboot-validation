...
object GreaterThanValidator: ConstraintValidator<Comparable<*>, GreaterThanConstraint>() {
	...
	override suspend fun validate(
		...
		value
			?: return null
		val otherValue = getPropertyValue(name = constraint.property, context = context)
			?: return null
	...
	override fun applicableErrorCodes(): Array<ApiErrorCode> = arrayOf(ApiErrorCode.GREATER_THAN_VIOLATION, ApiErrorCode.DEPENDENCY_TYPE_VIOLATION)
}