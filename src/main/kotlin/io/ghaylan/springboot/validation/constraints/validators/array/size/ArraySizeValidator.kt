...
object ArraySizeValidator: ConstraintValidator<Any, ArraySizeConstraint>() {
	...
	override suspend fun validate(
		...
		return ApiError(code = ApiErrorCode.ARRAY_SIZE_VIOLATION,
			message = "Array must contain between ${constraint.min} and ${constraint.max} elements")
	}
	
	override fun applicableErrorCodes(): Array<ApiErrorCode> = arrayOf(ApiErrorCode.ARRAY_SIZE_VIOLATION)
}