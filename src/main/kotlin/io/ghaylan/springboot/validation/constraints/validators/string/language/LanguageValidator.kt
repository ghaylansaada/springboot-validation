...
object LanguageValidator: ConstraintValidator<CharSequence, LanguageConstraint>() {
	...
	override suspend fun validate(
		...
		return ApiError(code = ApiErrorCode.ISO_LANGUAGE_CODE_VIOLATION,
			message = "Must be a valid language tag in the format 'xx' or 'xx-YY', " + "where 'xx' is a 2-letter ISO 639-1 language code and 'YY' is a 2-letter ISO 3166-1 country code.")
	}
	...
	override fun applicableErrorCodes(): Array<ApiErrorCode> = arrayOf(ApiErrorCode.ISO_LANGUAGE_CODE_VIOLATION)
}