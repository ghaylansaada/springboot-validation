...
object PasswordValidator : ConstraintValidator<CharSequence, PasswordConstraint>()
{
    ...
    override fun applicableErrorCodes(): Array<ApiErrorCode> = arrayOf(
        ApiErrorCode.PASSWORD_LENGTH_VIOLATION,
        ApiErrorCode.PASSWORD_UPPERCASE_VIOLATION,
        ApiErrorCode.PASSWORD_LOWERCASE_VIOLATION,
        ApiErrorCode.PASSWORD_DIGIT_VIOLATION,
        ApiErrorCode.PASSWORD_SPECIAL_CHAR_VIOLATION,
        ApiErrorCode.PASSWORD_ENTROPY_VIOLATION)
}