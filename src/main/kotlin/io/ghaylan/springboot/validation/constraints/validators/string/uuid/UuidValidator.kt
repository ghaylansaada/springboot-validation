...
object UuidValidator: ConstraintValidator<CharSequence, UuidConstraint>() {
	...
	override suspend fun validate(
		...
		return ApiError(code = ApiErrorCode.UUID_PATTERN_VIOLATION,
			message = "Must be a valid UUID string, e.g. 123e4567-e89b-12d3-a456-426614174000")
	}
	
	
	override fun applicableErrorCodes(): Array<ApiErrorCode> = arrayOf(ApiErrorCode.UUID_PATTERN_VIOLATION)
}