...
/**
 * Validates that the annotated temporal value is strictly in the future.
 * The optional `within*` properties narrow the window: the value must also be before
 * (now + the specified duration), e.g. `withinDays = 7` requires the value within the next 7 days.
 *
